...
/**
 * Базовий клас одягу для лабораторної роботи №7.
 * Демонструє наслідування — від нього успадковуються Pants і Shirts.
 * Поля size і material — типи перерахувань.
 * Без статичного лічильника та агрегації (видалено за вимогою методички).
 */
public class Clothes {
    ...
    /**
     * Створює об'єкт одягу з валідацією усіх параметрів.
     *
     * @param name     назва (не null, не порожня)
     * @param size     розмір (enum Size, не null)
     * @param color    колір (не null, не порожній)
     * @param price    ціна (> 0)
     * @param material матеріал (enum Material, не null)
